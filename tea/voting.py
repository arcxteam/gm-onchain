...
# ======================== Configuration ========================
CONFIG = {
    "RPC_URLS": os.getenv("RPC_URLS","https://tea-sepolia.g.alchemy.com/public",).split(","),
    "CONTRACT_ADDRESS": os.getenv("CONTRACT_ADDRESS", "0xa86612A24Ea19739d7Ab864cf9f948dF970165A6"),
    "PRIVATE_KEY_FILE": os.path.join(os.path.dirname(__file__), "private_keys.txt"),
    "ENV_FILE": ".env",
    "MAX_RETRIES": 5,
    "GAS_MULTIPLIER": 1.11,
    "MAX_PRIORITY_GWEI": 30,
    "GAS_LIMIT": 200000,
    "GAS_MIN_GWEI": 50,
    "GAS_MAX_GWEI": 100,
    "GAS_RESET_GWEI": 50,
...
class VoteScheduler:
    ...
    def get_eip1559_gas_params(self):
        ...
        try:
            ...
            print(f"💱 Est. Transaction Cost: {Fore.YELLOW}{total_cost_eth:.9f} {CHAIN_SYMBOLS.get(self.web3.eth.chain_id, 'TEA')}{Fore.RESET}")
    ...
    def get_wallet_balance(self, address):
        try:
            ...
            token_symbol = CHAIN_SYMBOLS.get(chain_id, "TEA")
    ...
    def build_transaction(self, sender):
        try:
            ...
            if vote_type == "Vote":
                ...
                messages = ["Empowering OSS", "OSS devs", "No hype. No shortcuts", "Just OSS that ships", "Green.Glorious.Silent", "VoteDapps", "Open Source powers"]
